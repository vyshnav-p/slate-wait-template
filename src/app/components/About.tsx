...
export default function About() {
    return (
        <section className="max-w-[90vw] md:w-[45rem] w-[50rem] min-h-screen flex flex-col items-center mx-auto z-10 bg-background relative pt-40">
            ...
            <div className='flex flex-col w-full items-center justify-center mt-5'>
                ...
                <h1 className="font-semibold text-foreground-muted text-xl md:text-2xl">
                ...
                <div className="w-full relative flex flex-col md:flex-row items-center md:items-stretch justify-between gap-4 h-[30rem] md:h-[6rem] mt-5">
                    {[
                        ...
                        <div
                            key={idx}
                            className="h-full w-[15rem] md:w-full flex flex-col items-center justify-center gap-3 bg-surface-muted rounded-2xl border border-surface-muted-border"
                        >
                            {item.icon}
