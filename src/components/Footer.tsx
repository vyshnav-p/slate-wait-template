...
export default function Footer() {
    ...
    return (
        <footer className="bg-background flex flex-col items-center mx-auto z-10 relative mt-[12rem] md:mt-[25rem] overflow-x-clip">
            <h1 className='absolute bottom-[8rem] md:bottom-[4rem] lg:bottom-[0.5rem] left-1/2 transform -translate-x-1/2 text-[9rem] md:text-[15rem] lg:text-[20rem] font-bold text-foreground-muted opacity-20 hover:cursor-pointer hover:translate-y-[-3.5rem] hover:text-foreground hover:opacity-100 transition-all duration-500 ease-in-out z-0'>
