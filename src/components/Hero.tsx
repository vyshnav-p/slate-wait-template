...
export default function Hero() {
  return (
     <section id="hero" className="w-[90vw] md:w-[45rem] lg:w-[50rem] mx-auto flex flex-col items-center text-center pt-48">
        ...
        <motion.h1 initial={{ y: 10, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 0.3, delay: 0.1 }} className="text-3xl md:text-6xl font-semibold mt-3 max-w-[36rem]">Build Stunning Websites in Seconds</motion.h1>
        <motion.p initial={{ y: 10, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 0.3, delay: 0.3 }} className="text-sm md:text-base max-w-[25rem] mt-3 text-[#959595]">Create pixel-perfect websites with the power of AI. Just drag, drop, and go live.</motion.p>
        <motion.div initial={{ y: 10, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 0.3, delay: 0.5 }} className="relative w-full md:w-[25rem] h-[3rem] mt-8 ">
          <input
            type="text"
            placeholder="Your email"
            className="w-full h-full text-sm px-3 pr-[7rem] bg-surface-muted focus:bg-surface transition-colors duration-150 outline-none focus:outline-none border border-surface-muted-border focus:border-surface-border rounded-xl"
          />
          <button
        ...
        <div className="relative z-0 w-full">
          <motion.div initial={{ y: '100%' }} animate={{ y: 0 }} transition={{ duration: 0.6,delay: 0.8 }} className="flex items-center justify-center w-full h-[12rem] md:h-[32rem] bg-[#7a7b7c] rounded-3xl mt-24 p-0.5 z-0">
